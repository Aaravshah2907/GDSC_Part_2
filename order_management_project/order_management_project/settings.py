...
SECRET_KEY = 'django-insecure-y(xdv^08-(4ayyj4@@@_xmyzm_$)l92$!l4+f*c-dy$4t(rnf9'
...
if ENVIRONMENT == 'local':
    ...
    raise ValueError(
        "Invalid environment specified. Use 'local' or 'production'.")

# Common settings for all environments go here
